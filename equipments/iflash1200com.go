...
type AsServerIflash1200Com struct {
	MESSAGE_ORDER    int
	MESSAGE_LENGTH   int
	MESSAGE_TYPE     int
	QUERY            int
...
func NewAsServerIflash1200Com(name string, host string, conf tools.EquipmentConfig) *AsServerIflash1200Com {
	return &AsServerIflash1200Com{
		MESSAGE_ORDER:  0,
...
func (as *AsServerIflash1200Com) Connect() {
...
func (as *AsServerIflash1200Com) GetConnectionStatus() bool {
	return as.connectionStatus
}

func (as *AsServerIflash1200Com) Start() {
	for {
		resArr := make([]byte, 60)
...
func (as *AsServerIflash1200Com) parseReceived() {
	defer func() {
		as.dataReceived = nil
	}()
...
func (as *AsServerIflash1200Com) saveResults() {
	barcode := ""
...
func (as *AsServerIflash1200Com) getOrder() []string {
	var order []string
...
func (as *AsServerIflash1200Com) getOrderList() [][]string {
	return nil
}

func (as *AsServerIflash1200Com) GetType() string {
	return "server"
}

// func handleConnection(server *AsServerIflash1200Com) {
...
// func Maglumi800Lan() AsServerIflash1200Com {
// 	server := AsServerIflash1200Com{
// 		// Initialize your AsServerIflash1200Com properties here
