...
type AsServerIflash1200Lan struct {
	MESSAGE_ORDER    int
	MESSAGE_LENGTH   int
	MESSAGE_TYPE     int
	QUERY            int
...
func NewAsServerIflash1200Lan(name string, apiHost string, conf tools.EquipmentConfig) *AsServerIflash1200Lan {
	return &AsServerIflash1200Lan{
		MESSAGE_ORDER:  0,
		host:           conf.Host,
		apiHost:        apiHost,
		MESSAGE_LENGTH: 0,
...
func (d *AsServerIflash1200Lan) Connect() {
...
func (as *AsServerIflash1200Lan) GetConnectionStatus() bool {
	return as.connectionStatus
}

func (as *AsServerIflash1200Lan) Start() {
	for {
...
func (as *AsServerIflash1200Lan) parseReceived() {
	defer func() {
		as.dataReceived = nil
	}()
...
func (as *AsServerIflash1200Lan) saveResults() {
	barcode := ""
...
func (as *AsServerIflash1200Lan) getOrder() []string {
	var order []string
...
func (as *AsServerIflash1200Lan) getOrderList() [][]string {
	return nil
}

func (as *AsServerIflash1200Lan) GetType() string {
	return "server"
}

// func handleConnection(server *AsServerIflash1200Lan) {
...
// func Maglumi800Lan() AsServerIflash1200Lan {
// 	server := AsServerIflash1200Lan{
// 		// Initialize your AsServerIflash1200Lan properties here
